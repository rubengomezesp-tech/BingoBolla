export const WORLDS = [
  {
    ...
    icons: ["🌴", "🌅", "🏖️", "🍹", "🦩", "🛼", "🕶️", "⛱️"],
    cityWords: ["MIAMI", "BEACH", "OCEAN", "PALM", "NEON", "SUNSET", "CORAL", "WAVES"],
  },
  {
    id: "vegas",
    ordinal: 2,
    ...
    icons: ["🎰", "🎲", "♠️", "♥️", "💎", "🍒", "🎯", "👑"],
    cityWords: ["VEGAS", "CASINO", "LIGHTS", "LUCKY", "STRIP", "JACKPOT", "POKER", "NEVADA"],
  },
  {
    id: "la",
    ordinal: 3,
    ...
    icons: ["🌃", "🎬", "⭐", "🎤", "🚗", "🌇", "🎥", "🌴"],
    cityWords: ["ANGEL", "STAR", "MOVIE", "BEVERLY", "SUNSET", "HOLLY", "VENICE", "MALIBU"],
  },
  {
    id: "california",
    ordinal: 4,
    ...
    icons: ["🏄", "🌊", "🌲", "🌉", "☀️", "🌻", "🐻", "🥑"],
    cityWords: ["GOLDEN", "SURF", "WAVE", "BRIDGE", "REDWOOD", "COAST", "YOSEMITE", "PACIFIC"],
  },
  {
    id: "newyork",
    ordinal: 5,
    ...
    icons: ["🗽", "🚖", "🏙️", "🥯", "🍕", "🍎", "🌉", "🎭"],
    cityWords: ["EMPIRE", "TAXI", "BRONX", "QUEENS", "BAGEL", "BROADWAY", "MANHATTAN", "HARLEM"],
  },
];
