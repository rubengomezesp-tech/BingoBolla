...
@media (max-width:720px){.mw-topbar{align-items:flex-start;flex-wrap:wrap}.mw-player{min-width:0;flex:1}.mw-wallet{width:100%;margin-left:0}.mw-hero{min-height:auto}.mw-heroCopy{padding:26px 18px}.mw-hero h1{font-size:38px}.mw-hero p{font-size:14px}.mw-heroMap{min-height:340px}.mw-currentPin{left:42%;bottom:31%}.mw-currentPin img{width:90px;height:90px}.mw-mapStats{width:142px}.mw-summary{grid-template-columns:1fr}.mw-sectionHead{align-items:flex-start;flex-direction:column}.mw-worldGrid{grid-template-columns:1fr;overflow:visible}.mw-worldCard{min-width:0;min-height:286px}.mw-contentGrid{gap:12px}.mw-heroActions{display:grid}.mw-primary,.mw-secondary{justify-content:center}.mw-backdrop img{width:110vw;height:70vh;right:-34%;bottom:10%;opacity:.12}}
